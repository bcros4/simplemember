...
<tr class="swpm-registration-height-row">
                <td><label for="height"><?php echo SwpmUtils::_('Height(cm)') ?></label></td>
                <td><input type="text" id="height" value="<?php echo esc_attr($height); ?>" size="50" name="height" /> </td>
            </tr>
<tr class="swpm-registration-weight-row">
                <td><label for="weight"><?php echo SwpmUtils::_('Weight(kg)') ?></label></td>
                <td><input type="text" id="weight" value="<?php echo esc_attr($weight); ?>" size="50" name="weight" /></td>
            </tr>
...
<tr class="swpm-registration-phone-row">
 ...
 <tr class="swpm-registration-staffcode-row">
                <td><label for="staff_code"><?php echo SwpmUtils::_('Staff Code') ?></label></td>
                <td><input type="text" id="staff_code" value="<?php echo esc_attr($staff_code); ?>" size="50" name="staff_code" /></td>
            </tr>
